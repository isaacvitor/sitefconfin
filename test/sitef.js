...
describe('SUIT Sitef - LayoutContent AJ', () => {
  ...
  before(function() {
    ...
    dataLayout = helper.parseDataToLayoutSection(layout.aj, dataAJ)
    aj = dataLayout[0]
  });
  
  it('Position 001002 is equal "AJ" ', () => {
    assert.strictEqual(helper.getValueByPosition('001002', aj), 'AJ')
  })
  
  it('Position 003017 is equal "001234567000123" ', () => {
    assert.strictEqual(helper.getValueByPosition('003017', aj), '001234567000123')
  })

  it('Position 018029 is equal "000012345678" ', () => {
    assert.strictEqual(helper.getValueByPosition('018029', aj), '000012345678')
  })

  it('Position 030037 is equal "20190124" ', () => {
    assert.strictEqual(helper.getValueByPosition('030037', aj), '20190124')
  })

  it('Position 038039 is equal 00 ', () => {
    assert.strictEqual(helper.getValueByPosition('038039', aj), '00')
  })

  it('Position 040051 is equal 12345678901 ', () => {
    assert.strictEqual(helper.getValueByPosition('040051', aj), '000012345678')
  })

  it('Position 052059 is equal 20190124 ', () => {
    assert.strictEqual(helper.getValueByPosition('052059', aj), '20190124')
  })

  it('Position 060065 is equal 140000 ', () => {
    assert.strictEqual(helper.getValueByPosition('060065', aj), '140000')
  })

  it('Position 066066 is equal 0 ', () => {
    assert.strictEqual(helper.getValueByPosition('066066', aj), '0')
  })

  it('Position 067074 is equal 20190124 ', () => {
    assert.strictEqual(helper.getValueByPosition('067074', aj), '20190124')
  })

  it('Position 075075 is equal 3 ', () => {
    assert.strictEqual(helper.getValueByPosition('075075', aj), '3')
  })

  it('Position 076076 is equal 1 ', () => {
    assert.strictEqual(helper.getValueByPosition('076076', aj), '1')
  })

  it('Position 077079 is equal 123 ', () => {
    assert.strictEqual(helper.getValueByPosition('077079', aj), '123')
  })

  it('Position 110120 is equal 00000001000 ', () => {
    assert.strictEqual(helper.getValueByPosition('110120', aj), '00000001000')
  })

  it('Position 121131 is equal 00000000010 ', () => {
    assert.strictEqual(helper.getValueByPosition('121131', aj), '00000000010')
  })

  it('Position 132142 is equal 0000000990 ', () => {
    assert.strictEqual(helper.getValueByPosition('132142', aj), '00000000990')
  })

  it('Position 143145 is equal 001 ', () => {
    assert.strictEqual(helper.getValueByPosition('143145', aj), '001')
  })

  it('Position 146151 is equal 123456 ', () => {
    assert.strictEqual(helper.getValueByPosition('146151', aj), '123456')
  })

  it('Position 152162 is equal 09876543211 ', () => {
    assert.strictEqual(helper.getValueByPosition('152162', aj), '09876543211')
  })

  it('Position 163181 is equal 000606153******7890 ', () => {
    assert.strictEqual(helper.getValueByPosition('163181', aj), '000606153******7890')
  })

  it('Position 182184 is equal 000 ', () => {
    assert.strictEqual(helper.getValueByPosition('182184', aj), '000')
  })

  it('Position 185187 is equal 000 ', () => {
    assert.strictEqual(helper.getValueByPosition('185187', aj), '000')
  })

  it('Position 188193 is equal 000003 ', () => {
    assert.strictEqual(helper.getValueByPosition('188193', aj), '000003')
  })
...
describe('SUIT Sitef - LayoutContent CC', () => {
  ...
  before(function() {
    dataLayout = helper.parseDataToLayoutSection(layout.cc, dataCC)
    cc = dataLayout[0]
  });
  
  it('Position 001002 is equal "CC" ', () => {
    assert.strictEqual(helper.getValueByPosition('001002', cc), 'CC')
  })
  
  it('Position 003017 is equal "001234567000123" ', () => {
    assert.strictEqual(helper.getValueByPosition('003017', cc), '001234567000123')
  })

  it('Position 018029 is equal "000012345678" ', () => {
    assert.strictEqual(helper.getValueByPosition('018029', cc), '000012345678')
  })

  it('Position 030037 is equal "20181211" ', () => {
    assert.strictEqual(helper.getValueByPosition('030037', cc), '20181211')
  })

  it('Position 038039 is equal 00 ', () => {
    assert.strictEqual(helper.getValueByPosition('038039', cc), '00')
  })

  it('Position 040051 is equal 12345678901 ', () => {
    assert.strictEqual(helper.getValueByPosition('040051', cc), '000012345678')
  })

  it('Position 052059 is equal 20190124 ', () => {
    assert.strictEqual(helper.getValueByPosition('052059', cc), '20190124')
  })

  it('Position 060065 is equal 140000 ', () => {
    assert.strictEqual(helper.getValueByPosition('060065', cc), '140000')
  })

  it('Position 066066 is equal 1 ', () => {
    assert.strictEqual(helper.getValueByPosition('066066', cc), '1')
  })

  it('Position 067072 is equal 4 ', () => {
    assert.strictEqual(helper.getValueByPosition('067072', cc), '000004')
  })
})
...
describe('SUIT Sitef - LayoutContent L9', () => {
  ...
  before(function() {
    dataLayout = helper.parseDataToLayoutSection(layout.l9, dataL9)
    l9 = dataLayout[0]
  });
  
  it('Position 001002 is equal "L9" ', () => {
    assert.strictEqual(helper.getValueByPosition('001002', l9), 'L9')
  })
  
  it('Position 003008 is equal 000003 ', () => {
    assert.strictEqual(helper.getValueByPosition('003008', l9), '000003')
  })

  it('Position 009022 is equal "00000000001000" ', () => {
    assert.strictEqual(helper.getValueByPosition('009022', l9), '00000000001000')
  })

  it('Position 023028 is equal 5 ', () => {
    assert.strictEqual(helper.getValueByPosition('023028', l9), '000005')
  })
})
...
describe('SUIT Sitef - LayoutContent A9', () => {
  ...
  before(function() {
    dataLayout = helper.parseDataToLayoutSection(layout.a9, dataA9)
    a9 = dataLayout[0]
  });
  
  it('Position 001002 is equal "A9" ', () => {
    assert.strictEqual(helper.getValueByPosition('001002', a9), 'A9')
  })
  
  it('Position 003008 is equal 000004 ', () => {
    assert.strictEqual(helper.getValueByPosition('003008', a9), '000004')
  })

  it('Position 009014 is equal 000006 ', () => {
    assert.strictEqual(helper.getValueByPosition('009014', a9), '000006')
  })
})
